...
USERNAME = "test_user_family_2"
PASSWORD = "test123"
EMAIL = "test_family_2@example.com"
...
def register_additional_users():
    ...
    additional_users = [
        {
            "username": "test_user_invite_1",
            "password": "test123",
            "email": "test_invite_1@example.com",
            "full_name": "邀请测试用户1"
        },
        {
            "username": "test_user_invite_2", 
            "password": "test123",
            "email": "test_invite_2@example.com",
            "full_name": "邀请测试用户2"
        }
    ]
    ...
    for user_data in additional_users:
        ...
        if response.status_code in [200, 201]:
            ...
            result = response.json()
            if "已存在" in result.get("message", "") or "已被注册" in result.get("message", ""):
...
def test_create_family_with_invite(token, invite_users):
    ...
    # 创建家庭数据
    family_data = {
        "family_name": "测试家庭_添加成员功能_v2",
        "description": "用于测试添加成员功能的家庭v2",
